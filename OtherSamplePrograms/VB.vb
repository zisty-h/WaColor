...
Public Structure WaColor
    ...
    Public Structure Kinako
        Public Shared Light As Color     = Color.FromArgb(216, 210, 82) ' #D8D252
        Public Shared Normal As Color    = Color.FromArgb(183, 176, 33) ' #B7B021
        Public Shared Deep As Color      = Color.FromArgb(150, 142, 0)  ' #968E00
    End Structure

    Public Structure Sora
        Public Shared Light As Color     = Color.FromArgb(69, 186, 204)  ' #45BACC
        Public Shared Normal As Color    = Color.FromArgb(0, 139, 160)   ' #008BA0
        Public Shared Deep As Color      = Color.FromArgb(0, 99, 114)    ' #006372
    End Structure
End Structure
