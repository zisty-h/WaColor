...
public struct WaColor
{
    ...
    {
        public static Color Light   = Color.FromArgb(216, 210, 82); // #D8D252
        public static Color Normal  = Color.FromArgb(183, 176, 33); // #B7B021
        public static Color Deep    = Color.FromArgb(150, 142, 0);  // #968E00
    }

    public struct Sora
    {
        public static Color Light   = Color.FromArgb(69, 186, 204); // #45BACC
        public static Color Normal  = Color.FromArgb(0, 139, 160);  // #008BA0
        public static Color Deep    = Color.FromArgb(0, 99, 114);   // #006372
    }
}
